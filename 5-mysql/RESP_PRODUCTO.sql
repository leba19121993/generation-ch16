...
-- -----------------------------------------------------
-- Table `ejemplo_producto`.`COMPRA_has_COMPRA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ejemplo_producto`.`COMPRA_has_COMPRA` ;

CREATE TABLE IF NOT EXISTS `ejemplo_producto`.`COMPRA_has_COMPRA` (
  `COMPRA_CLIENTE_dni` INT NOT NULL,
  `COMPRA_PRODUCTO_codigo` INT NOT NULL,
  PRIMARY KEY (`COMPRA_CLIENTE_dni`, `COMPRA_PRODUCTO_codigo`),
  INDEX `fk_COMPRA_has_COMPRA_COMPRA1_idx` (`COMPRA_CLIENTE_dni` ASC, `COMPRA_PRODUCTO_codigo` ASC) VISIBLE,
  CONSTRAINT `fk_COMPRA_has_COMPRA_COMPRA1`
    FOREIGN KEY (`COMPRA_CLIENTE_dni` , `COMPRA_PRODUCTO_codigo`)
    REFERENCES `ejemplo_producto`.`COMPRA` (`CLIENTE_dni` , `PRODUCTO_codigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
